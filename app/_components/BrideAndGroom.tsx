...
import brideImg from '@/app/_assets/images/our-album/album_8.jpg';
...
export const BrideAndGroom = () => {
    ...
    return (
        <section className='min-h-screen py-8 px-4 bg-transparent overflow-hidden'>
                                    ...
                                    <p
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t('brideAndGroom.bride.info', {
                                                father: `<strong>${t('brideAndGroom.bride.father')}</strong>`,
                                                mother: `<strong>${t('brideAndGroom.bride.mother')}</strong>`,
                                            }),
                                        }}
                                    />
                                </div>
            ...
            {/* Groom Section */}
            <div className='max-w-[800px] mx-auto' data-aos='fade-in' data-aos-once='true' data-aos-duration='600'>
                <div
                    className='bg-[#2a2a2a] rounded-[24px] p-8 md:p-12 overflow-hidden'
                    data-aos='fade-left'
                    data-aos-once='true'
                                    ...
                                    <p
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t('brideAndGroom.groom.info', {
                                                father: `<strong>${t('brideAndGroom.groom.father')}</strong>`,
                                                mother: `<strong>${t('brideAndGroom.groom.mother')}</strong>`,
                                            }),
                                        }}
                                    />
                                </div>
