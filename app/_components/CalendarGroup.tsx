'use client';
import image1 from '../_assets/images/our-album/album_2.jpg';
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Polaroid Card */}
                <div className='mt-1 w-full max-w-[350px] mb-10' data-aos='flip-up' data-aos-delay='800'>
                    <PolaroidCard imageSrc={image1.src} text={t('calendar.polaroidQuote')} />
                </div>
            </div>
        </section>
    );
